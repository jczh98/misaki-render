...
Logger::Logger(LogLevel log_level)
    : m_log_level(log_level), m_error_level(Error) {}
Logger::~Logger() { delete m_formatter; }
void Logger::set_log_level(LogLevel level) { m_log_level = level; }
void Logger::set_error_level(LogLevel level) { m_error_level = level; }
LogLevel Logger::error_level() const { return m_error_level; }
void Logger::set_formatter(Formatter *formatter) { m_formatter = formatter; }
Formatter *Logger::formatter() { return m_formatter; }
const Formatter *Logger::formatter() const { return m_formatter; }
#undef Throw
void Logger::log(LogLevel level, const char *filename, int line,
